  ...
  return (
    <View style={styles.contentContainer}>
      ...
      <Text style={styles.description}>
        Ingresa el correo electrónico del usuario con el que deseas compartir tu
        tarea. Comparten un tarea con alguien y manténgase sincronizado con sus
        objetivos todos los días.
      </Text>
      <TextInput
        value={email}
